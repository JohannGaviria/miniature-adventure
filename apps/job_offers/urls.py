...
urlpatterns = [
    ...
    path('job_offers/close/<str:job_offer_id>', views.close_job_offer, name='close_job_offer'),
    path('job_offers/delete/<str:job_offer_id>', views.delete_job_offer, name='delete_job_offer'),
]
